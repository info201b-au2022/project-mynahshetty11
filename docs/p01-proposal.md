...
Our dataset is related to our project domain because it illustrates the number of cases of disease to a country, how many people fall under the poverty line, open defection rates, and handwashing rates. This can help us answer our questions on how poverty, access to clean water and sanitation methods, and diagnosis of cholera/ diarrheal disease are correlated. The Global Health Organization collected this data, it was last updated in 2021. This data is derived through surveillance and household surveys. Surveying is funded by asssessed contributions by country and voluntary contributions from member states. Citizens in poverty stricken areas who are affected by unclean water may gain from these datasets because more people will see how dangerous not having access to clean water is. Non-profits may also be able to gain from this to help more people in need of access to sanitation methods. Those that collect data for the World hEALTH organization need to cross examine their data to keep it accurate and relevant. WHO also keeps fact sheets to measure when their data is collected to accurately predict if it is up to date. We obtained this data through a link on the design brief that was provided. We do credit the soure of this data because we see that WHO is a very credible sourvce and has helped us gain an understanding of the data and its effects.
