...
## Conclusion
In summary, our interest in how poverty effects the increased chance of disease has led us to make many discoveries that illustrate problems that are in desperate need to be solved. We first were able to see how countries that fall under the “poor”, or “extremely poor” categories have much less access to handwashing services than those under “average”, or “rich”. Then we can see how handwashing services are not improving as much as they need to be over the past 10 years. This shows us the systematic problems within poverty-stricken countries, when it comes to access to sanitation services. Countries that cannot afford to provide clean sanitation services will put their citizens under a much greater risk of disease and will likely have higher death rates. It is extremely important for these trends to be seen so solutions can start to be put in place.
