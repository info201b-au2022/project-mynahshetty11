...
## Findings
1.	Has access to handwashing improved over time?
Through the chart made in our first interactive visualization, we are able to illustrate a lot of findings between handwashing services and time in each country. Our chart splits the data between countries in the years of 2000-2020. We found that handwashing rates generally stay stagnant or increase over times. We can also see hoe the data set ranges from six percent access to handwashing services, to ninety nine percent access to handwashing services. This uncovers the vast disparity between countries in terms of being able to provide handwashing access to citizens.
2.	What is the relationship between proportion of people without access to clean water, sanitation services and the proportion of people who get infected with cholera?
Through the chart in our second interactive visualization, we are bel to illustrate a lot of findings between percent of countries with access to handwashing services and different levels of poverty. Our chart splits countries in to 5 categories, rich, average, slightly poor, poor, and extremely poor. Then we can sort by year to see how the country poverty levels change in access to handwashing services over time. We see that overall, rich countries have the most access to handwashing, with extremely poor and poor countries consistently having the least access to handwashing services.

## Discussion
From our findings we can draw the conclusion that higher poverty levels in countries leads to less access to clean handwashing services. This is vital in analyzing the systems that can then help improve sanitation services in countries with higher poverty levels. Its common sense to come to the conclusion that less sanitation leads to higher chances of contracting disease. When poverty stricken, countries can afford to provide clean sanitation services for residents, people will find unclean methods for sanitation, which will lead to higher disease contraction, and therefore, higher death rates. It’s extremely important to see these connections, because when systems like sanitation are not analyzed, millions of people are at risk to die every day. Once cracks in the system are put out for people to see, is when we can start to mend these cracks, and find solutions that can save lives.

## Conclusion
In summary, our interest in how poverty effects the increased chance of disease has led us to make many discoveries that illustrate problems that are in desperate need to be solved. We first were able to see how countries that fall under the “poor”, or “extremely poor” categories have much less access to handwashing services than those under “average”, or “rich”. Then we can see how handwashing services are not improving as much as they need to be over the past 10 years. This shows us the systematic problems within poverty-stricken countries, when it comes to access to sanitation services. Countries that cannot afford to provide clean sanitation services will put their citizens under a much greater risk of disease and will likely have higher death rates. It is extremely important for these trends to be seen so solutions can start to be put in place.![image](https://user-images.githubusercontent.com/113277318/206430894-02fbcc3a-2176-415f-aaab-ddd87ca04308.png)
